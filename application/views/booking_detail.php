    ...
    <div class="container-fluid page-header">
        <h1 class="display-3 text-uppercase text-white mb-3">Detail Pemesanan</h1>
        <div class="d-inline-flex text-white">
            <h6 class="text-uppercase text-body m-0">Detail Booking</h6>
        </div>
    </div>
    <!-- Page Header Start -->
    <?php 
            ...
            <div class="row">
                ...
                <div class="col-lg-5 mb-2">
                    ...
                    <div class="bg-light p-5 mb-5">
                        ...
                        <p>Status Pembayaran : <span class="kanan"><?= $checkout['trans_status'] ?></span></p>
                        <p>Harga Sewa : <span class="kanan"><?= rp($paket['pack_price']) ?></span></p>
                        <?php if ($checkout['trans_sp_id']==null){}else{ ?>
                        <p>Harga Antar/Jemput : <span class="kanan"><?= rp($sp['sp_price']) ?></span></p>
                        <?php } ?>
                        <hr>
