...
<head>
	...
	<!-- Include PaymentAPI  -->
	<link rel="stylesheet" href="<?php echo base_url();?>assets_admin/paym/css/jquery.fancybox.css">
</head>
<body>
	<script type="text/javascript" src="https://api.sandbox.veritrans.co.id/v2/assets/js/veritrans.min.js"></script>
	<script src="//ajax.googleapis.com/ajax/libs/jquery/1.11.0/jquery.min.js"></script>
	<script type="text/javascript" src="<?php echo base_url();?>assets_admin/paym/js/jquery.fancybox.pack.js"></script>
	...
	$(function(){
		...
		Veritrans.client_key = "SB-Mid-client-n9c9B26wWtckK7Zs";
