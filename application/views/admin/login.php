...
<body background="<?= base_url('assets_admin/img/bgadmin.jpg') ?>">
    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-xl-10 col-lg-12 col-md-9">
                ...
                <div class="card o-hidden border-0 shadow-lg my-5" style="margin-top: 200px !important; background: rgba(255, 255, 255, 0.5) !important;">
                    <div class="card-body p-0">
                        <!-- Nested Row within Card Body -->
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block ">
                                <img src="<?= base_url('upload/icon/logonew.jpg')?>" class="img-fluid" alt="">
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
