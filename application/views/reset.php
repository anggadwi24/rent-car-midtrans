...
<body>
    ...
    <div class="container-fluid ">
        <div class="container pt-5">
            ...
            <h1 class="display-4 text-uppercase text-center mb-5 text-primary">ATUR ULANG KATA SANDI</h1>
            ...
            <div class="row">
                <div class="col-lg-9 mb-2">
                    <div class="contact-form bg-light mb-4" style="padding: 30px;">
                        <form action="<?= base_url('forgot/doreset') ?>" method="post">
                            <div class="form-group">
                                <label for="">Halo, <?= $row['cus_name'] ?></label>
                            </div>
                            <div class="form-group">
                                <label>Kata Sandi</label>
                                <input type="password" class="form-control p-4" placeholder="Masukan kata sandi baru" required="required" name="password">
                            </div>
                            <div class="form-group">
                               
                                <input type="password" class="form-control p-4" placeholder="Masukan ulang kata sandi baru" required="required" name="repass">
                            </div>
                           <input type="hidden" name="id" value="<?= encode($row['cus_id']) ?>">
